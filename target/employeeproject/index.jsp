...
<body>
    ...
    <form id="file-upload-form" action="/upload" method="post" enctype="multipart/form-data"> 
        <label for="name-field">Name:</label> <input type="text" id="name-field" name="name" required><br><br>
         <label for="empid-field">Employee ID:</label> <input type="text" id="empid-field" name="empid" required><br><br>
        <h4>Documents</h4>
        <div id="documents">
            <div class="document"> <select class="document-type">
